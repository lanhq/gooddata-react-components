...
storiesOf("NewHighCharts", module)
                ...
                {wrap(
                    <ChartTransformation
                        drillableItems={[
                            {
                                uri:
                                    dataSet2.executionResult.headerItems[VIEW_BY_DIMENSION_INDEX][0][0]
    ...
    .add("Bloated dashboard test", () => {
        // last minute add, forgive me the copy&paste
        const measurings: any[] = [];
        const startTime = performance.now();
